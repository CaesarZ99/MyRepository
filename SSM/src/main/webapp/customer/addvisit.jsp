...
<body>
	...
	<form action="${pageContext.request.contextPath}/addvisitView"
		...
		<table class="maintable" width="100%" border="0" cellspacing="0">
			<tr>
				...
				<td width="201" height="24"><select name="cusid"><c:forEach items="${cuslist}" var="r">
						<option value="${r.cusid }">${r.cusname }</option>
					</c:forEach></select></td>
				<td width="473"></td>
			</tr>
			<tr>
				...
				<td height="24"><input name="vdate" type="date"
			...
			<tr>
				<td width="104">
					<div align="right">回访事件：</div>
				</td>
				<td height="24"><input name="vevent" type="text"
					class="inputcontent" id="text" size="20" maxlength="16" /></td>
				<td height="24"></td>
			</tr>
			...
			<tr>
				<td width="104">
					<div align="right">回访记录：</div>
				</td>
				<td height="24"><label> <textarea name="vnote"></textarea>
				</label></td>
				<td height="24"></td>
			</tr>
		</table>
