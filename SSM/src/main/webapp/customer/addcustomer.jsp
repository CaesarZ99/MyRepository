...
<body>
	...
	<table border="0" width="100%" cellspacing="0">
		<tr>
			<td background="images/topBarBg.gif" height="23"><strong>
					<div class="searchfontlist">添加客户</div>
			</strong></td>
		</tr>
	</table>
	...
	<form action="${pageContext.request.contextPath}/addCustomerView" method="post">
		<table class="maintable" width="100%" border="0" cellspacing="0">
			...
			<tr>
				...
				<td height="24"><label> <input type="radio" value="男"
						name="cusgender"> 男
				</label> <label> <input type="radio" value="女" name="cusgender">
						女
				</label></td>
				<td height="24"></td>
			</tr>
