	...
	<form name="listform" action="../sell/listcar.jsp" method="post"
		...
		<table class="maintable" width="97%" border="0" cellspacing="0">
			...
			<tr>
				...
				<td><input type="text" name="porDate" id="mailingTime2"
					onClick="show_cele_date(this,'','',this)"></td>
				<td><div align="center">入库日期</div></td>
				<td><input type="text" name="wareDate" id="mailingTime"
					onClick="show_cele_date(this,'','',this)"></td>
			</tr>
			...
			<tr>
				<td height="121" colspan="4" align="center"><textarea
						name="carDes" id="texts" cols="140" rows="5"></textarea></td>
			</tr>
		</table>
		<option></option>
		<option></option>
