...
<body>
	...
	<form action="${pageContext.request.contextPath}/updatepur" method="post"
		onSubmit="return subRole();">
		<table class="maintable" width="100%" border="0" cellspacing="0">
			<c:forEach items="${plist}" var="p">
				<c:if test="${p.powerid==updatepowerId}">
					<tr>
						<td width="104"><div align="right">
								权限编号：<input name="powerid" readonly="readonly" value="${p.powerid}" style="width: 83px; height: 29px"/>
							</div></td>
					...
					<tr>
						...
						<td height="24"><textarea name="powername" id="powername">${p.powername}</textarea></td>
						<td height="24"></td>
					</tr>
				</c:if>
			</c:forEach>
		...
		<table align="right" width="100%">
			<tr>
				...
				<td width="96"><div align="center">
						<label> <input onClick="history.back()" type="button"
