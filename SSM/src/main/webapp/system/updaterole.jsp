	...
	<form action="${pageContext.request.contextPath}/updateRole" method="post">
		<table class="maintable" width="100%" border="0" cellspacing="0">
			<c:forEach items="${rlist}" var="r">
				<c:if test="${r.roleid==updateRoleId}">
					<tr>
						<td width="104" ><div align="right"><input name="roleid" value="${r.roleid}" type="hidden" />角色编号：</div></td>
						<td height="24" colspan="2" id="">${r.roleid}</td>
					</tr>
					<tr>
						<td width="104"><div align="right">角色名称：</div></td>
						<td width="239" height="24"><input name="rolename"
							value="${r.rolename}" type="text" class="inputcontent"
							id="rolename" size="20"></td>
						<td width="435"></td>
					</tr>
					<tr>
						<td width="104"><div align="right">角色描述：</div></td>
						<td height="24"><textarea name="rolediscription" id="rolediscription">${r.rolediscription}</textarea></td>
						<td height="24"></td>
					</tr>
					<tr>
						...
						<td height="24" colspan="2">
								<tr>
									<td height="24" colspan="2"><select name="powerid" id="powerid">
								<c:forEach items="${plist}" var="p">
									<option value="${p.powerid}">${p.powerid}. ${p.powername}</option>
								</c:forEach>
